...
def convert_to_dict(headers,intf_list):
	result = [dict(zip(headers,intf_tup)) for intf_tup in intf_list   ]
	return result
	
	

if __name__ == "__main__":
	intf_list = parse_sh_ip_int_br('sh_ip_int_br_2.txt')
	list_of_intfs_dict = convert_to_dict(headers,intf_list)
	pprint(list_of_intfs_dict)
