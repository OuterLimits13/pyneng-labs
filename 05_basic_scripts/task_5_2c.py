...
avalible_dev_keys = str(london_co[dev].keys())   
avalible_dev_keys = avalible_dev_keys[ avalible_dev_keys.find('[')+1 : avalible_dev_keys.find(']') ].replace('\'','')    

param = input('Enter parameter  ('  + avalible_dev_keys + '): ')
print('-' * 30)
