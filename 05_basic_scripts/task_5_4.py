...
# solution
word_temp = word_list[::-1]
num_temp = num_list[::-1]

x = int(input('Введите число: '))
print(str(x) + ' последний раз встречается с индексом ' + str( (len(num_list) - 1 - num_temp.index(x)) ) ) 

x = input('Введите слово (python, ruby, perl): ')
print(x + ' последний раз встречается с индексом ' + str( (len(word_list) - 1 - word_temp.index(x)) ) ) 
